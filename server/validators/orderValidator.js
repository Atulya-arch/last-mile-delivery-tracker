...
export const createOrderSchema = z.object({
  ...
  pickupAddress: z.string().trim().min(5, { message: 'Pickup address must be at least 5 characters long' }),
  deliveryAddress: z.string().trim().min(5, { message: 'Delivery address must be at least 5 characters long' }),
